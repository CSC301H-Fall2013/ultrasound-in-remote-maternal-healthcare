...
*/
$config['tables']['users']           = 'ultrasound.users';
$config['tables']['groups']          = 'ultrasound.groups';
$config['tables']['users_groups']    = 'ultrasound.users_groups';
$config['tables']['login_attempts']  = 'ultrasound.login_attempts';
 ...
 */
$config['site_title']                 = "ultrasound.azurewebsites.net";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'fieldworker';           // Default group, use name
$config['admin_group']                = 'superuser';             // Default administrators group, use name
...
$config['forgot_password_expiration'] = 600000;              // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
